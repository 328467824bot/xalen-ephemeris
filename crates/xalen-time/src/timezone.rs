...
///
/// # Returns
/// Julian Date LABELLED as the UT1 time scale. The input is civil clock time,
/// so the result is really civil UTC treated as an **approximation of UT1**
/// (UTC ≈ UT1 to within ±0.9 s; no DUT1 correction is applied — see
/// [`crate::calendar_to_jd`]).
