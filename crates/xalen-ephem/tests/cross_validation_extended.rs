...
#[test]
fn delta_t_at_1900() {
    // The SMH2016 model evaluates the published Table-S15 cubic spline across
    // the full historical range; at 1900.0 (spline row [1900,1905], t=0) it
    // returns a0 = -1.977 s, consistent with observed early-20th-century ΔT.
...
fn delta_t_extrapolation_2050() {
    // Past the last fitted spline knot (AD 2016) the SMH2016 model uses its own
    // long-term lod-integral extrapolation tail; at 2050 it returns ≈71.0 s.
