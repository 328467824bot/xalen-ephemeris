...
///
/// Formulas referenced from Tajik Neelakanthi / Encyclopedia of Vedic Astrology
/// (Dr. Shanker Adawal, Ch. V Part 2).
///
...
pub fn detect_tajaka_yogas(
    ...
    for i in 0..planets.len() {
        ...
        // Duhphali
        if !malefics.contains(&name_i) && check_duhphali(sign_i, &malefic_signs) {
