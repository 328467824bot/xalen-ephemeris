...
| [`kp-astro-android/`](kp-astro-android/) | Kotlin/Android + WebView | KP astrology Android app — WebView hybrid (HTML/JS/CSS + XALEN WASM), native shell for clipboard/share/export |
